<template>
  <div class="header">
    ...
    <h2 @click="reload" class="title">Dj List</h2>
...
@mixin exborder($color: #fff) {
  ...
  text-shadow: 1.5px 1.5px 0 $color, -1.5px 1.5px 0 $color,
    1.5px -1.5px 0 $color, -1.5px -1.5px 0 $color;
  // 下
  text-shadow: 1.5px 1.5px 1.5px $color, -1.5px 1.5px 1.5px $color,
    1.5px -1.5px 1.5px $color, -1.5px -1.5px 1.5px $color;
}
