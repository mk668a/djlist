  ...
  <div class="search">
    <div class="searchform">
      <div class="form">
        ...
        <el-button type="primary" class="searchButton" icon="el-icon-search" @click="toform(input)"></el-button>
      </div>
    </div>
    <div class="tags">
      <div
        ...
        class="tag"
        @click="toform(item)"
        style="font-family:'nicomojiPlus';"
      >{{item}}</div>
    ...
    getTags(items) {
      ...
      while (width < tagsWidth / divide_size) {
        ...
        if (
          item != undefined &&
          item != "" &&
          this.IsArrayExists(this.tags, item)
        ) {
          this.tags.push(item);
          // console.log(item);
